...
public class Email_Survey_Updated_In_Survey_Body_Auto_Test extends BaseClass{
	double startTime;
	double stopTime;
	...
	public void CeditSurvey() throws Throwable {
		...
		manageSurveys.selectClient();
		  ...
		  editSurvey = manageSurveys.selectSurvey(); editSurvey.clickShowButton();
		  ...
		  editSurvey.enter_E_mail_SubjectForInvitation();
			  ...
			  editSurvey.enter_FromName(); editSurvey.enter_Email_Sender();
	...
	public void DxEmailLogin_SurveySubmit() throws Throwable {
		...
		String emailSubjectWeProvideInSurveyWithTextCode = prop.getProperty("E_mail_Subject_For_Invitation");
		...
		System.out.println("Successfully validate subject");
		  ...
		  String emailBodyInMailInbox1 =""; for(WebElement mailBodyLine : emailBodyInMailInboxLines) { 
			  emailBodyInMailInbox1 += mailBodyLine.getText();
		  } 
		  String emailBodyInMailInbox = emailBodyInMailInbox1.trim();
		  
		  String emailBodyWeProvideInSurvey_With_TextCode =prop.getProperty("E_mail_Body_For_Invitation"); 
		  ...
		  driver.findElement(By.xpath("//select[@name='obj349813']")); 
		  } 
